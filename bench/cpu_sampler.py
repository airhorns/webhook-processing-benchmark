...
"""
CPU sampler. Polls a target PID + all descendants and writes one line per sample
to a file: `<timestamp_ms> <cpu_pct_sum>`. Runs until SIGTERM or PID disappears.
